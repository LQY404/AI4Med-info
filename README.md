...
|   |   |   |   |
| :------------: | :------------: | :------------: | :------------: |
| MICCAI | [HistGen: Histopathology Report Generation via Local-Global Feature Encoding and Cross-modal Context Interaction](https://arxiv.org/abs/2403.05396) | [code](https://github.com/dddavid4real/HistGen) |  |
